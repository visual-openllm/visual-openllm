        ...
        if past_key_values is None:
            ...
            if position_ids is None:
                position_ids = self.get_position_ids(
                    seq=seq, mask_position=mask_position, device=input_ids.device, gmask=use_gmask
                )
        ...
        if past is not None or past_key_values is not None:
            ...
            if self.position_encoding_2d:
                position_ids = torch.tensor(
                    [[[mask_position], [len(seq) - context_length]]], dtype=torch.long, device=input_ids.device
                )
            else:
            ...
            attention_mask, position_ids = self.get_masks_and_position_ids(
                seq=seq, mask_position=mask_position, context_length=len(seq), device=input_ids.device, gmask=use_gmask
            )
